package com.leocs.cursomc.resources.exceptions;
...
import com.leocs.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(System.currentTimeMillis(), cod.value(), "Erro Amazon Service", e.getMessage(), request.getRequestURI());
