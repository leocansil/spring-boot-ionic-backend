...
import com.leocs.cursomc.domain.PagamentoComCartao;
...
import com.leocs.cursomc.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "leocansil@yahoo.com.br", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "leocansil@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		
		cli2.getTelefones().addAll(Arrays.asList("9388321", "343252625"));
		...
		clientepository.saveAll(Arrays.asList(cli1,cli2));
